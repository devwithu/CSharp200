...
namespace Project130.StudentDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([Student_ID] = @Original_Student_ID) AND ([Student_Name] = @Original_Student_Name) AND ([Student_Phone] = @Original_Student_Phone) AND ([Student_Address] = @Original_Student_Address) AND ([Student_chk] = @Original_Student_chk) AND ([Student_InDate] = @Original_Student_InDate))";
...
SELECT Student_ID, Student_Name, Student_Phone, Student_Address, Student_chk, Student_InDate FROM Student WHERE (Student_ID = @Student_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Project130.Properties.Settings.Default.STUDENTDATABASEConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Student_ID, Student_Name, Student_Phone, Student_Address, Student_chk, Stu" +
                "dent_InDate FROM dbo.Student WHERE Student_chk=\'N\'";
