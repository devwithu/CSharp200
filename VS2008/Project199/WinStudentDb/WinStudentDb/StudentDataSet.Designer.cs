...
SELECT Student_ID, Student_Name, Student_Phone, Student_Address, Student_chk, Student_InDate FROM Student WHERE (Student_ID = @Student_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT  Student_ID, Student_Name, Student_Phone, Student_Address, Student_chk, St" +
                "udent_InDate\r\nFROM     Student\r\nWHERE  (Student_chk = \'N\')";
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Student_ID", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Student_ID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._commandCollection[3].CommandText = "SELECT  Student_ID, Student_Name, Student_Phone, Student_Address, Student_chk, St" +
                "udent_InDate\r\nFROM     Student";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "SELECT  Student_ID, Student_Name, Student_Phone, Student_Address, Student_chk, St" +
                "udent_InDate\r\nFROM     Student\r\nWHERE  (Student_chk = \'Y\') AND (Student_ID = @St" +
                "udent_ID)";
            ...
            this._commandCollection[5].CommandText = "SELECT  Student_ID, Student_Name, Student_Phone, Student_Address, Student_chk, St" +
                "udent_InDate\r\nFROM     Student\r\nWHERE  (Student_chk = \'N\') AND (Student_Name LIK" +
                "E @Student_Name)";
            ...
            this._commandCollection[6].CommandText = "SELECT  Student_ID, Student_Name, Student_Phone, Student_Address, Student_chk, St" +
                "udent_InDate\r\nFROM     Student\r\nWHERE  (Student_chk = \'N\') AND (Student_ID = @St" +
                "udent_ID)";
            ...
            this._commandCollection[7].CommandText = @"INSERT INTO Student
...
SET        Student_Name = @Student_Name, Student_Phone = @Student_Phone, Student_Address = @Student_Address, 
               Student_InDate = GETDATE()
WHERE  (Student_ID = @Student_ID); 
...
WHERE  (Student_ID = @Student_ID)";
        ...
        public virtual int DeleteQuery(string Original_Student_ID) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((Original_Student_ID == null)) {
                throw new global::System.ArgumentNullException("Original_Student_ID");
            }
            else {
                command.Parameters[0].Value = ((string)(Original_Student_ID));
            }
