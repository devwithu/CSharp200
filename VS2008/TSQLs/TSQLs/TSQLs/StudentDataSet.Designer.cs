...
namespace TSQLs {
    ...
    public partial class StudentDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentRow : global::System.Data.DataRow {
            ...
            public string Student_chk {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'Student\' 테이블의 \'Student_chk\' 열의 값이 DBNull입니다.", e);
                    }
                }
                set {
            ...
            public System.DateTime Student_InDate {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'Student\' 테이블의 \'Student_InDate\' 열의 값이 DBNull입니다.", e);
                    }
                }
                set {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public bool IsStudent_chkNull() {
                return this.IsNull(this.tableStudent.Student_chkColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public void SetStudent_chkNull() {
                this[this.tableStudent.Student_chkColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public bool IsStudent_InDateNull() {
                return this.IsNull(this.tableStudent.Student_InDateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public void SetStudent_InDateNull() {
                this[this.tableStudent.Student_InDateColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace TSQLs.StudentDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([Student_ID] = @Original_Student_ID) AND ([Student_Name] = @Original_Student_Name) AND ([Student_Phone] = @Original_Student_Phone) AND ([Student_Address] = @Original_Student_Address) AND ((@IsNull_Student_chk = 1 AND [Student_chk] IS NULL) OR ([Student_chk] = @Original_Student_chk)) AND ((@IsNull_Student_InDate = 1 AND [Student_InDate] IS NULL) OR ([Student_InDate] = @Original_Student_InDate)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_Student_chk", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Student_chk", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_Student_InDate", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Student_InDate", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Student] ([Student_ID], [Student_Name], [Student_Phone], [Student_Address], [Student_chk], [Student_InDate]) VALUES (@Student_ID, @Student_Name, @Student_Phone, @Student_Address, @Student_chk, @Student_InDate);
SELECT Student_ID, Student_Name, Student_Phone, Student_Address, Student_chk, Student_InDate FROM Student WHERE (Student_ID = @Student_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Student_ID] = @Student_ID, [Student_Name] = @Student_Name, [Student_Phone] = @Student_Phone, [Student_Address] = @Student_Address, [Student_chk] = @Student_chk, [Student_InDate] = @Student_InDate WHERE (([Student_ID] = @Original_Student_ID) AND ([Student_Name] = @Original_Student_Name) AND ([Student_Phone] = @Original_Student_Phone) AND ([Student_Address] = @Original_Student_Address) AND ((@IsNull_Student_chk = 1 AND [Student_chk] IS NULL) OR ([Student_chk] = @Original_Student_chk)) AND ((@IsNull_Student_InDate = 1 AND [Student_InDate] IS NULL) OR ([Student_InDate] = @Original_Student_InDate)));
SELECT Student_ID, Student_Name, Student_Phone, Student_Address, Student_chk, Student_InDate FROM Student WHERE (Student_ID = @Student_ID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_Student_chk", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Student_chk", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_Student_InDate", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Student_InDate", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TSQLs.Properties.Settings.Default.STUDENTDATABASEConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Student_ID, Student_Name, Student_Phone, Student_Address, Student_chk, Stu" +
                "dent_InDate FROM dbo.Student";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"INSERT INTO Student
               (Student_ID, Student_Name, Student_Phone, Student_Address, Student_chk, Student_InDate)
VALUES  (@Student_ID,@Student_Name,@Student_Phone,@Student_Address, 'N', GETDATE()); 
SELECT Student_ID, Student_Name, Student_Phone, Student_Address, Student_chk, Student_InDate FROM Student WHERE (Student_ID = @Student_ID)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Student_ID", global::System.Data.SqlDbType.NVarChar, 10, global::System.Data.ParameterDirection.Input, 0, 0, "Student_ID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Student_Name", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Student_Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Student_Phone", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Student_Phone", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Student_Address", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Student_Address", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Delete(string Original_Student_ID, string Original_Student_Name, string Original_Student_Phone, string Original_Student_Address, string Original_Student_chk, global::System.Nullable<global::System.DateTime> Original_Student_InDate) {
            ...
            if ((Original_Student_chk == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_Student_chk));
            }
            if ((Original_Student_InDate.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[6].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[7].Value = ((System.DateTime)(Original_Student_InDate.Value));
            }
            else {
        ...
        public virtual int Insert(string Student_ID, string Student_Name, string Student_Phone, string Student_Address, string Student_chk, global::System.Nullable<global::System.DateTime> Student_InDate) {
            if ((Student_ID == null)) {
            ...
            if ((Student_InDate.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((System.DateTime)(Student_InDate.Value));
            }
            else {
        ...
        public virtual int Update(string Student_ID, string Student_Name, string Student_Phone, string Student_Address, string Student_chk, global::System.Nullable<global::System.DateTime> Student_InDate, string Original_Student_ID, string Original_Student_Name, string Original_Student_Phone, string Original_Student_Address, string Original_Student_chk, global::System.Nullable<global::System.DateTime> Original_Student_InDate) {
            if ((Student_ID == null)) {
                throw new global::System.ArgumentNullException("Student_ID");
            }
            else {
            ...
            if ((Student_InDate.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((System.DateTime)(Student_InDate.Value));
            }
            else {
            ...
            if ((Original_Student_chk == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_Student_chk));
            }
            if ((Original_Student_InDate.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[12].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[13].Value = ((System.DateTime)(Original_Student_InDate.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Student_Name, string Student_Phone, string Student_Address, string Student_chk, global::System.Nullable<global::System.DateTime> Student_InDate, string Original_Student_ID, string Original_Student_Name, string Original_Student_Phone, string Original_Student_Address, string Original_Student_chk, global::System.Nullable<global::System.DateTime> Original_Student_InDate) {
