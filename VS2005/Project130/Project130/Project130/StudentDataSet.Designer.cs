...
namespace Project130.StudentDataSetTableAdapters {
...
SELECT Student_ID, Student_Name, Student_Phone, Student_Address, Student_InDate FROM Student WHERE (Student_ID = @Student_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Project130.Properties.Settings.Default.StudentConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Student_ID, Student_Name, Student_Phone, Student_Address,Student_InDate FR" +
                "OM dbo.Student WHERE  Student_chk=\'y\'";
